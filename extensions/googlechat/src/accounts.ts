...
export function listGoogleChatAccountIds(cfg: AGDIConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: AGDIConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: AGDIConfig): ResolvedGoogleChatAccount[] {
