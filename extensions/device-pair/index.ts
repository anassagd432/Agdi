...
async function resolveTailnetHost(api: AGDIPluginApi): Promise<string | null> {
...
function resolveAuth(cfg: AGDIPluginApi["config"]): ResolveAuthResult {
...
async function resolveGatewayUrl(api: AGDIPluginApi): Promise<ResolveUrlResult> {
