...
import { resolveChannelMediaMaxBytes, type AGDIConfig } from "openclaw/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: AGDIConfig; accountId?: string }): string[] {
