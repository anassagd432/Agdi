...
export function listBlueBubblesAccountIds(cfg: AGDIConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: AGDIConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: AGDIConfig): ResolvedBlueBubblesAccount[] {
