...
import { hasControlCommand, resolveControlCommandGate } from "agdi/plugin-sdk/command-auth";
...
import { evaluateMatchedGroupAccessForPolicy } from "agdi/plugin-sdk/group-access";
import {
