...
export function listZalouserAccountIds(cfg: AGDIConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: AGDIConfig): string {
...
function mergeZalouserAccountConfig(cfg: AGDIConfig, accountId: string): ZalouserAccountConfig {
