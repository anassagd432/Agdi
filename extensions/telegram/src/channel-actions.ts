...
} from "agdi/plugin-sdk/channel-actions";
...
import type { TelegramActionConfig } from "agdi/plugin-sdk/config-runtime";
import { extractToolSend } from "agdi/plugin-sdk/tool-send";
import {
