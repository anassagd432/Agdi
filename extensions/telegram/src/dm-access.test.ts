import type { createChannelPairingChallengeIssuer } from "agdi/plugin-sdk/channel-pairing";
...
vi.mock("agdi/plugin-sdk/channel-pairing", () => ({
  createChannelPairingChallengeIssuer: createChannelPairingChallengeIssuerMock,
}));

vi.mock("agdi/plugin-sdk/conversation-runtime", () => ({
