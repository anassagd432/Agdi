...
import type { GetReplyOptions, MsgContext } from "agdi/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("agdi/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("agdi/plugin-sdk/media-runtime")>,
) {
...
vi.mock("agdi/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("agdi/plugin-sdk/agent-runtime", async (importOriginal) => {
