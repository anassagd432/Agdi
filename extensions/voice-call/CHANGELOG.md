...
- Version alignment with core AGDI release numbers.
...
- First public release of the @agdi/voice-call plugin.
...
- CLI: `agdi voicecall` commands (call/start/continue/speak/end/status/tail/expose).
