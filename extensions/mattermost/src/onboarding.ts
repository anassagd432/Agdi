import type { ChannelOnboardingAdapter, AGDIConfig, WizardPrompter } from "openclaw/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.agdi.ai/channels/mattermost",
    ].join("\n"),
