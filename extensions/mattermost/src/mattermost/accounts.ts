...
export function listMattermostAccountIds(cfg: AGDIConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: AGDIConfig): string {
...
export function listEnabledMattermostAccounts(cfg: AGDIConfig): ResolvedMattermostAccount[] {
