...
Nostr DM channel plugin for AGDI using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to AGDI. It enables your bot to:
...
# Configure agdi to use local relay
