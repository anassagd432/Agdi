import type { BaseProbeResult } from "agdi/plugin-sdk/channel-contract";
import { resolveFetch } from "agdi/plugin-sdk/infra-runtime";
import { fetchWithTimeout } from "agdi/plugin-sdk/text-runtime";
