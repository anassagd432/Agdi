...
vi.mock("agdi/plugin-sdk/web-media", async () => {
...
let loadWebMedia: typeof import("agdi/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("agdi/plugin-sdk/web-media"));
