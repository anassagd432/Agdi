...
import { formatDurationSeconds } from "agdi/plugin-sdk/infra-runtime";
...
type LoadedConfig = ReturnType<typeof import("agdi/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("agdi/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("agdi/plugin-sdk/runtime-env").createSubsystemLogger>;
