...
import type { SessionBindingRecord } from "agdi/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "agdi/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "agdi/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("agdi/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("agdi/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("agdi/plugin-sdk/config-runtime").OpenClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
