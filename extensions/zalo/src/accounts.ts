...
export function listZaloAccountIds(cfg: AGDIConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: AGDIConfig): string {
...
function mergeZaloAccountConfig(cfg: AGDIConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: AGDIConfig): ResolvedZaloAccount[] {
