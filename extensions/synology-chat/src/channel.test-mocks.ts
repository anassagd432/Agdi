...
vi.mock("agdi/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("agdi/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("agdi/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("agdi/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("agdi/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("agdi/plugin-sdk/webhook-ingress");
  return {
    ...actual,
