import { ensureAuthProfileStore, listProfilesForProvider } from "agdi/plugin-sdk/agent-runtime";
import { definePluginEntry, type ProviderAuthContext } from "agdi/plugin-sdk/plugin-entry";
import { coerceSecretRef } from "agdi/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "agdi/plugin-sdk/provider-auth-login";
