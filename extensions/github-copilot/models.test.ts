...
vi.mock("agdi/plugin-sdk/provider-models", () => ({
...
vi.mock("agdi/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("agdi/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/openclaw-state",
}));

import type { ProviderResolveDynamicModelContext } from "agdi/plugin-sdk/core";
