...
function listConfiguredAccountIds(cfg: AGDIConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: AGDIConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AGDIConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: AGDIConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: AGDIConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: AGDIConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AGDIConfig): ResolvedWhatsAppAccount[] {
