...
export function listSlackAccountIds(cfg: AGDIConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: AGDIConfig): string {
...
function mergeSlackAccountConfig(cfg: AGDIConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: AGDIConfig): ResolvedSlackAccount[] {
