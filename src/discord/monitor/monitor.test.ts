...
describe("agent components", () => {
  const createCfg = (): AGDIConfig => ({}) as AGDIConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockReset().mockReturnValue("/tmp/agdi-sessions-test.json");
  });
