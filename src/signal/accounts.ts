...
export function listSignalAccountIds(cfg: AGDIConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: AGDIConfig): string {
...
function mergeSignalAccountConfig(cfg: AGDIConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AGDIConfig): ResolvedSignalAccount[] {
