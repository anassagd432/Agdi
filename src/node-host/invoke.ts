...
const execHostEnforced = (process.env.AGDI_NODE_EXEC_HOST ?? process.env.OPENCLAW_NODE_EXEC_HOST)?.trim().toLowerCase() === "app";
const execHostFallbackAllowed =
  (process.env.AGDI_NODE_EXEC_FALLBACK ?? process.env.OPENCLAW_NODE_EXEC_FALLBACK)?.trim().toLowerCase() !== "0";
