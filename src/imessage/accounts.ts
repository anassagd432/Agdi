...
export function listIMessageAccountIds(cfg: AGDIConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: AGDIConfig): string {
...
function mergeIMessageAccountConfig(cfg: AGDIConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: AGDIConfig): ResolvedIMessageAccount[] {
