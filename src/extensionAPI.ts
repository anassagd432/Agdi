...
const shouldWarnExtensionApiImport =
  ...
  (process.env.AGDI_SUPPRESS_EXTENSION_API_WARNING ?? process.env.OPENCLAW_SUPPRESS_EXTENSION_API_WARNING) !== "1";

if (shouldWarnExtensionApiImport) {
  process.emitWarning(
    "openclaw/extension-api is deprecated. Migrate to api.runtime.agent.* or focused agdi/plugin-sdk/<subpath> imports. See https://docs.agdi.ai/plugins/sdk-migration",
    {
      code: "OPENCLAW_EXTENSION_API_DEPRECATED",
      detail:
        "This compatibility bridge is temporary. Bundled plugins should use the injected plugin runtime instead of importing host-side agent helpers directly. Migration guide: https://docs.agdi.ai/plugins/sdk-migration",
    },
  );
}
