...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/agdi/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/agdi/extensions",
        global: "/Users/x/.agdi/extensions",
        workspace: "/Users/x/ws/.agdi/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.agdi/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/agdi/extensions",
        global: "/Users/x/.agdi/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.agdi/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/agdi/extensions",
        global: "/Users/x/.agdi/extensions",
