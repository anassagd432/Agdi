...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @agdi/voice-call -> voice-call).
...
export function discoverAGDIPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".agdi", "extensions")];
