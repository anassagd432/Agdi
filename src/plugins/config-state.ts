...
export const normalizePluginsConfig = (config?: AGDIConfig["plugins"]): NormalizedPluginsConfig => {
...
const hasExplicitMemorySlot = (plugins?: AGDIConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: AGDIConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: AGDIConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
