...
const ensureAGDIModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveAGDIAgentDir = vi.fn().mockReturnValue("/tmp/agdi-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/agdi-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureAGDIModelsJson,
}));
