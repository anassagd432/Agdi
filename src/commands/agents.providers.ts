...
function resolveDefaultAccountId(cfg: AGDIConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AGDIConfig): boolean {
...
export function summarizeBindings(cfg: AGDIConfig, bindings: AgentBinding[]): string[] {
