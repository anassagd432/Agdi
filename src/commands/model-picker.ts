...
type PromptDefaultModelResult = { model?: string; config?: AGDIConfig };
...
function resolveConfiguredModelRaw(cfg: AGDIConfig): string {
...
function resolveConfiguredModelKeys(cfg: AGDIConfig): string[] {
...
export function applyPrimaryModel(cfg: AGDIConfig, model: string): AGDIConfig {
...
export function applyModelAllowlist(cfg: AGDIConfig, models: string[]): AGDIConfig {
  const defaults = cfg.agents?.defaults;
