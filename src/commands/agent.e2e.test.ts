...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "agdi-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<AGDIConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<AGDIConfig["telegram"]>>,
