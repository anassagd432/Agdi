...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/agdi/agdi/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.AGDI_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.agdi/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: AGDIConfig = {
    ...params.cfg,
