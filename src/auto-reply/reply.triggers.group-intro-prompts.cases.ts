  ...
  describe("group intro prompts", () => {
    ...
    const cases: GroupIntroCase[] = [
      ...
      },
      {
        ...
        expected: [
          `You are in the WhatsApp group chat "Ops". Your replies are automatically sent to this group chat. Do not use the message tool to send to this same group â€” just reply normally.`,
