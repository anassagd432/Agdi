...
function resolveMentionPatterns(cfg: AGDIConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AGDIConfig | undefined, agentId?: string): RegExp[] {
