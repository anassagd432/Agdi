...
export function listBindings(cfg: AGDIConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: AGDIConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AGDIConfig) {
