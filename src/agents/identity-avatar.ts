...
function resolveAvatarSource(cfg: AGDIConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AGDIConfig, agentId: string): AgentAvatarResolution {
