...
const RAW_STREAM_ENABLED = isTruthyEnvValue(process.env.AGDI_RAW_STREAM ?? process.env.OPENCLAW_RAW_STREAM);
const RAW_STREAM_PATH =
  (process.env.AGDI_RAW_STREAM_PATH ?? process.env.OPENCLAW_RAW_STREAM_PATH)?.trim() ||
