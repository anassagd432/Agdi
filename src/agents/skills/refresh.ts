...
function resolveWatchPaths(workspaceDir: string, config?: AGDIConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AGDIConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AGDIConfig }) {
