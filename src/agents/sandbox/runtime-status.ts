...
function resolveMainSessionKeyForSandbox(params: { cfg?: AGDIConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: AGDIConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(`- See: ${formatCliCommand(`agdi sandbox explain --session ${runtime.sessionKey}`)}`);
