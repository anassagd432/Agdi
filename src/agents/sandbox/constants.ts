...
export const DEFAULT_SANDBOX_IMAGE = "agdi-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "agdi-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "agdi-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "agdi-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "agdi-sbx-browser-";
