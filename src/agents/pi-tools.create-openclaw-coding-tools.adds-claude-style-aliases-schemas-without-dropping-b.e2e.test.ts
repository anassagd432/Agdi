...
describe("createAGDICodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createAGDICodingTools({
      config,
    ...
    const anthropicTools = createAGDICodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createAGDICodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createAGDICodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
