...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.AGDI_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: AGDIConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AGDIConfig): string {
...
function mergeTelegramAccountConfig(cfg: AGDIConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: AGDIConfig): ResolvedTelegramAccount[] {
