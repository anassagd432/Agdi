...
export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "AGDI_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "AGDI_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
