    ...
    if (!entry) {
      await prompter.note(
        [
          ...
          `  ${formatCliCommand("agdi configure --section web")}`,
          "",
      ...
      await prompter.note(
        [
          ...
          `  ${formatCliCommand("agdi configure --section web")}`,
          "",
          `Get your key at: ${entry?.signupUrl ?? "https://docs.agdi.ai/tools/web"}`,
          "Docs: https://docs.agdi.ai/tools/web",
        ].join("\n"),
        "Web search",
      );
      ...
      await prompter.note(
        [
          ...
          `Re-enable: ${formatCliCommand("agdi configure --section web")}`,
          "",
          "Docs: https://docs.agdi.ai/tools/web",
        ].join("\n"),
        "Web search",
