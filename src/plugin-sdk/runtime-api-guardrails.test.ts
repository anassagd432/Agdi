...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  "extensions/googlechat/runtime-api.ts": ['export * from "agdi/plugin-sdk/googlechat";'],
  "extensions/matrix/runtime-api.ts": [
    'export * from "./src/auth-precedence.js";',
    'export * from "./helper-api.js";',
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "agdi/plugin-sdk/ssrf-runtime";',
    ...
    'export { writeJsonFileAtomically } from "agdi/plugin-sdk/json-store";',
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, OpenClawConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "agdi/plugin-sdk/matrix";',
    'export { formatZonedTimestamp } from "agdi/plugin-sdk/matrix";',
  ],
  "extensions/nextcloud-talk/runtime-api.ts": [
    'export * from "agdi/plugin-sdk/nextcloud-talk";',
  ],
  ...
  "extensions/telegram/runtime-api.ts": [
    'export type { ChannelMessageActionAdapter, ChannelPlugin, OpenClawConfig, OpenClawPluginApi, PluginRuntime, TelegramAccountConfig, TelegramActionConfig, TelegramNetworkConfig } from "agdi/plugin-sdk/telegram";',
    'export type { TelegramApiOverride } from "./src/send.js";',
    'export type { OpenClawPluginService, OpenClawPluginServiceContext, PluginLogger } from "agdi/plugin-sdk/core";',
    'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "agdi/plugin-sdk/acp-runtime";',
    'export { AcpRuntimeError } from "agdi/plugin-sdk/acp-runtime";',
    'export { buildTokenChannelStatusSummary, clearAccountEntryFields, DEFAULT_ACCOUNT_ID, normalizeAccountId, PAIRING_APPROVED_MESSAGE, parseTelegramTopicConversation, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses, resolveTelegramPollVisibility } from "agdi/plugin-sdk/telegram";',
    'export { buildChannelConfigSchema, getChatChannelMeta, jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections, TelegramConfigSchema } from "agdi/plugin-sdk/telegram-core";',
