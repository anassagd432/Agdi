...
export type { AGDIConfig } from "../config/config.js";
/** @deprecated Use AGDIConfig instead */
export type { AGDIConfig as ClawdbotConfig } from "../config/config.js";
