...
import type { AGDIPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverAGDIPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, AGDIPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["AGDI_PLUGIN_CATALOG_PATHS", "AGDI_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<AGDIPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: AGDIPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverAGDIPlugins({ workspaceDir: options.workspaceDir });
