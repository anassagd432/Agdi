...
This directory contains hooks that ship with AGDI. These hooks are automatically discovered and can be enabled/disabled via CLI or configuration.
...
2. Restart gateway: `pkill -9 -f 'agdi.*gateway' && pnpm agdi gateway`
