...
import type { AGDIPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: AGDIPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: AGDIPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
