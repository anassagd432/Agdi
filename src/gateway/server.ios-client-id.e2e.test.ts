...
beforeAll(async () => {
  previousToken = process.env.AGDI_GATEWAY_TOKEN;
  process.env.AGDI_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
afterAll(async () => {
  ...
  if (previousToken === undefined) {
    ...
    process.env.AGDI_GATEWAY_TOKEN = previousToken;
  }
});
...
test.each([
  { clientId: "agdi-ios", platform: "ios" },
  { clientId: "agdi-android", platform: "android" },
