...
import { type AGDIConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AGDIConfig): string[] {
...
export function listAgentsForGateway(cfg: AGDIConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AGDIConfig): string {
...
function resolveSessionStoreAgentId(cfg: AGDIConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: AGDIConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: AGDIConfig): GatewaySessionsDefaults {
