  ...
  constructor(path: string) {
    super(
      [
        ...
        "Fix: set AGDI_GATEWAY_TOKEN/AGDI_GATEWAY_PASSWORD (compatibility: OPENCLAW_GATEWAY_TOKEN/OPENCLAW_GATEWAY_PASSWORD), pass explicit --token/--password,",
...
export function resolveGatewayCredentialsFromConfig(params: {
  ...
  const localTokenPrecedence =
    ...
    ((env.AGDI_SERVICE_KIND ?? env.OPENCLAW_SERVICE_KIND) === "gateway"
      ? "config-first"
      : "env-first");
