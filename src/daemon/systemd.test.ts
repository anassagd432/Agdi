...
const GATEWAY_SERVICE = "agdi-gateway.service";
  ...
  it.each([
    {
      ...
      env: { HOME: "/home/test" },
      expected: "/home/test/.config/systemd/user/agdi-gateway.service",
    },
    {
      ...
      expected: "/home/test/.config/systemd/user/agdi-gateway-jbphoenix.service",
    },
    {
...
describe("systemd service control", () => {
  ...
  it("restarts a profile-specific user unit", async () => {
    execFileMock
      .mockImplementationOnce((_cmd, _args, _opts, cb) => cb(null, "", ""))
      .mockImplementationOnce((_cmd, args, _opts, cb) => {
        assertUserSystemctlArgs(args, "restart", "agdi-gateway-work.service");
        cb(null, "", "");
      });
