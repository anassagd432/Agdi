    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["agdi directory self --channel slack", "Show the connected account identity."],
          [
            'agdi directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["agdi directory groups list --channel discord", "List available groups/channels."],
          [
            "agdi directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.agdi.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
