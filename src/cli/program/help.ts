...
const EXAMPLES = [
  ["agdi channels login --verbose", "Link personal WhatsApp Web and show QR + connection logs."],
  [
...
export function configureProgramHelp(program: Command, ctx: ProgramContext) {
  program
    ...
    .option(
      "--profile <name>",
      "Use a named profile (isolates AGDI_STATE_DIR/AGDI_CONFIG_PATH under ~/.agdi-<name>)",
    );
