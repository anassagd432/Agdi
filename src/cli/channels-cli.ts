    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["agdi channels list", "List configured channels and auth profiles."],
          ["agdi channels status --probe", "Run channel status checks and probes."],
          [
            "agdi channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["agdi channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.agdi.ai/cli/channels",
        )}\n`,
    );
