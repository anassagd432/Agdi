...
import type { AutonomousAgentConfig } from "./types.autonomous.js";
...
export type AGDIConfig = {
  meta?: {
    /** Last AGDI version that wrote this config. */
  ...
  ui?: {
    /** Accent color for AGDI UI chrome (hex). */
    seamColor?: string;
    assistant?: {
