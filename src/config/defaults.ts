...
function resolveAnthropicDefaultAuthMode(cfg: AGDIConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AGDIConfig): AGDIConfig {
...
export function applyTalkApiKey(config: AGDIConfig): AGDIConfig {
...
export function applyModelDefaults(cfg: AGDIConfig): AGDIConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AGDIConfig): AGDIConfig {
...
export function applyLoggingDefaults(cfg: AGDIConfig): AGDIConfig {
...
export function applyContextPruningDefaults(cfg: AGDIConfig): AGDIConfig {
...
export function applyCompactionDefaults(cfg: AGDIConfig): AGDIConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
