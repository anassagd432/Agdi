...
export const A2UI_PATH = "/__agdi__/a2ui";

export const CANVAS_HOST_PATH = "/__agdi__/canvas";

export const CANVAS_WS_PATH = "/__agdi__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.agdiCanvasA2UIAction.postMessage(...)
  // - Android: window.agdiCanvasA2UIAction.postMessage(...)
  const handlerNames = ["agdiCanvasA2UIAction"];
  ...
  globalThis.AGDI = globalThis.AGDI ?? {};
  globalThis.AGDI.postMessage = postToNode;
  globalThis.AGDI.sendUserAction = sendUserAction;
  globalThis.agdiPostMessage = postToNode;
  globalThis.agdiSendUserAction = sendUserAction;
