...
const templates: Template[] = [
  {
    ...
    model: "claude-opus-4.6", systemPrompt: "You are an expert software engineer. Write clean, well-documented, production-quality code.",
  ...
  },
  {
    ...
    model: "gpt-5.4", systemPrompt: "You are a thorough researcher. Search the web, verify facts, cite sources, and synthesize findings.",
  ...
  },
  {
    ...
    model: "claude-sonnet-4.6", systemPrompt: "You are a skilled writer. Create engaging, clear, and well-structured content.",
  ...
  },
  {
    ...
    model: "gemini-3.1-pro", systemPrompt: "You are a data analyst. Analyze data, identify patterns, and present insights clearly.",
  ...
  },
  {
    ...
    model: "claude-haiku-4.5", systemPrompt: "You are a friendly customer support agent. Help users with their questions professionally.",
  ...
  },
  {
    ...
    model: "o3", systemPrompt: "You are a cybersecurity expert. Audit code and configurations for security vulnerabilities.",
  ...
  },
  {
    ...
    model: "grok-4.2", systemPrompt: "You are a highly creative thinker. Generate novel ideas, alternatives, and creative solutions.",
