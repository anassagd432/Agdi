...
This is the full reference for `agdi onboard`.
...
<Steps>
  ...
  <Step title="Web search">
    ...
    - Configure later: `agdi configure --section web`.
  </Step>
...
```bash
export AGDI_GATEWAY_TOKEN="your-token"
agdi onboard --non-interactive \
  --mode local \
  --auth-choice skip \
  --gateway-auth token \
  --gateway-token-ref-env AGDI_GATEWAY_TOKEN
```
