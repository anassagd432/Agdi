...
# WhatsApp
agdi message poll --target +15555550123 \
  --poll-question "Lunch today?" --poll-option "Yes" --poll-option "No" --poll-option "Maybe"
agdi message poll --target 123456789@g.us \
  --poll-question "Meeting time?" --poll-option "10am" --poll-option "2pm" --poll-option "4pm" --poll-multi

# Discord
agdi message poll --channel discord --target channel:123456789 \
  --poll-question "Snack?" --poll-option "Pizza" --poll-option "Sushi"
agdi message poll --channel discord --target channel:123456789 \
  --poll-question "Plan?" --poll-option "A" --poll-option "B" --poll-duration-hours 48

# Microsoft Teams
agdi message poll --channel msteams --target conversation:19:abc@thread.tacv2 \
...
- Microsoft Teams: Adaptive Card polls (Agdi-managed). No native poll API; `durationHours` is ignored.
...
to record votes in `~/.agdi/msteams-polls.json`.
