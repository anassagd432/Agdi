...
状态存储在 Agdi 状态目录下。默认为 `~/.agdi`。如果设置了 `OPENCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.agdi.ai/testing
- https://docs.agdi.ai/start/getting-started
