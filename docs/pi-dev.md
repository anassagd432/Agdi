...
This guide summarizes a sane workflow for working on the pi integration in AGDI.
...
- Trigger the agent directly:
  - `pnpm agdi agent --message "Hello" --thinking low`
...
State lives under the AGDI state directory. Default is `~/.agdi`. If `AGDI_STATE_DIR` is set, use that directory instead.

To reset everything:

- `agdi.json` for config
...
- [https://docs.agdi.ai/testing](https://docs.agdi.ai/testing)
- [https://docs.agdi.ai/start/getting-started](https://docs.agdi.ai/start/getting-started)
