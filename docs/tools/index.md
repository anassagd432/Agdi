---
summary: "Agdi tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools Agdi provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Some plugins are **core** (shipped with Agdi), others are **external**
...
These tools ship with Agdi and are available without installing any plugins:
...
| `group:nodes`      | nodes                                                                                                     |
| `group:agdi`   | All built-in Agdi tools (excludes plugin tools)                                                       |
