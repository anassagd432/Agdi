...
When a site requires login, **sign in manually** in the **host** browser profile (the agdi browser).
...
Agdi controls a **dedicated Chrome profile** (named `agdi`, orange‑tinted UI). This is separate from your daily browser profile.
