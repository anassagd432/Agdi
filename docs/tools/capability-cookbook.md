---
summary: "Contributor guide for adding a new shared capability to the Agdi plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Agdi core developers. If you are
  building an external plugin, see [Building Plugins](/plugins/building-plugins)
  instead.
</Info>

Use this when Agdi needs a new domain such as image generation, video
