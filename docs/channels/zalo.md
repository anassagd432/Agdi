...
This page reflects current Agdi behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `agdi pairing list zalo`
  - `agdi pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Agdi.
...
- Example: `agdi message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `agdi channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `agdi logs --follow`
