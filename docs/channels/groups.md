...
Agdi treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

Agdi “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Agdi can see that group and respond there.
...
Translation: allowlisted senders can trigger Agdi by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@agdi", "agdi", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
