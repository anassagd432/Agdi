...
Agdi treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.agdi/settings/voicewake.json`

Shape:

```json
{ "triggers": ["agdi", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
