...
services:
  - type: web
    ...
    envVars:
      ...
      - key: AGDI_STATE_DIR
        value: /data/.agdi
      - key: AGDI_WORKSPACE_DIR
        value: /data/workspace
      - key: AGDI_GATEWAY_TOKEN
...
The web dashboard is available at `https://<your-service>.onrender.com/agdi`.
...
This downloads a portable backup you can restore on any AGDI host.
