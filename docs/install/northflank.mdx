...
Deploy AGDI on Northflank with a one-click template and finish setup in your browser.
...
8. Open the public AGDI URL and complete setup at `/setup`.
9. Open the Control UI at `/agdi`.
...
4. Click **Run setup**.
5. Open the Control UI at `https://<your-northflank-domain>/agdi`
