---
title: Fly.io
summary: "Step-by-step Fly.io deployment for Agdi with persistent storage and HTTPS"
read_when:
  - Deploying Agdi on Fly.io
...
<Steps>
  ...
  <Step title="Create config file">
    ...
    **Note:** With `OPENCLAW_STATE_DIR=/data`, the config path is `/data/agdi.json`.
