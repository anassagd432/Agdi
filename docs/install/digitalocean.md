---
summary: "Host Agdi on a DigitalOcean Droplet"
read_when:
  - Setting up Agdi on DigitalOcean
  - Looking for a simple paid VPS for Agdi
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent Agdi Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `agdi doctor --non-interactive` and check logs with `journalctl --user -u agdi-gateway.service -n 50`.
