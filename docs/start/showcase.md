...
read_when:
  - Looking for real Agdi usage examples
...
A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via an Agdi persona.
</Card>
