...
CLI onboarding is the **recommended** way to set up Agdi on macOS,
...
`agdi configure --section web`. Docs: [Web tools](/tools/web).
</Tip>
...
If the config is invalid or contains legacy keys, onboarding asks you to run `agdi doctor` first.
</Note>
