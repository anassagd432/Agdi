---
summary: "Overview of Agdi onboarding options and flows"
read_when:
...
Agdi has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `agdi onboard`                     | Launch the app            |
...
CLI command docs: [`agdi onboard`](/cli/onboard)

## macOS app onboarding

Open the Agdi app. The first-run wizard walks you through the same steps
