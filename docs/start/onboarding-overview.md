...
AGDI supports multiple onboarding paths depending on where the Gateway runs
...
- [`agdi onboard` command](/cli/onboard)

## macOS app onboarding

Use the AGDI app when you want a fully guided setup on macOS. Docs:
