---
summary: "First-run setup flow for Agdi (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Agdi">
...
<Step title="CLI">
  ...
  The app can install the global `agdi` CLI via npm/pnpm so terminal
