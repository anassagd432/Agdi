---
summary: "Use NVIDIA's OpenAI-compatible API in AGDI"
read_when:
  - You want to use NVIDIA models in AGDI
...
agdi onboard --auth-choice skip
agdi models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
