---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with AGDI"
read_when:
  - You want Xiaomi MiMo models in AGDI
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). AGDI uses
