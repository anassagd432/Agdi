...
```bash
agdi chat --model venice/llama-3.3-70b "Hello, are you working?"
```
...
```bash
agdi models set venice/claude-opus-45
agdi models set venice/llama-3.3-70b
```
...
agdi chat --model venice/llama-3.3-70b

# Use Claude via Venice (anonymized)
agdi chat --model venice/claude-opus-45

# Use uncensored model
agdi chat --model venice/venice-uncensored

# Use vision model with image
agdi chat --model venice/qwen3-vl-235b-a22b

# Use coding model
agdi chat --model venice/qwen3-coder-480b-a35b-instruct
```
