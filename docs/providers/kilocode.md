---
title: "Kilo Gateway"
summary: "Use Kilo Gateway's unified API to access many models in Agdi"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in Agdi
---
...
```bash
agdi onboard --kilocode-api-key <key>
```
...
Agdi dynamically discovers available models from the Kilo Gateway at startup. Use
