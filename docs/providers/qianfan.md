---
summary: "Use Qianfan's unified API to access many models in AGDI"
read_when:
...
3. AGDI installed on your system
...
4. Copy the API key for use with AGDI

## CLI setup

```bash
agdi onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [AGDI Configuration](/gateway/configuration)
