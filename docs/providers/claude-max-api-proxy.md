...
You can point Agdi at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Agdi
...
- [Anthropic provider](/providers/anthropic) - Native Agdi integration with Claude setup-token or API keys
