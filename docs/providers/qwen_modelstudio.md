...
read_when:
  - You want to use Qwen (Alibaba Cloud Model Studio) with Agdi
...
```bash
# China endpoint
agdi onboard --auth-choice modelstudio-standard-api-key-cn

# Global/Intl endpoint
agdi onboard --auth-choice modelstudio-standard-api-key
```
...
```bash
# China endpoint
agdi onboard --auth-choice modelstudio-api-key-cn

# Global/Intl endpoint
agdi onboard --auth-choice modelstudio-api-key
```
