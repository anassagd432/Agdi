...
read_when:
  - You are building a AGDI plugin
...
Every plugin **must** ship a `agdi.plugin.json` file in the **plugin root**.
AGDI uses this manifest to validate configuration **without executing plugin
