---
summary: "Install and use Codex, Claude, and Cursor bundles as Agdi plugins"
read_when:
  - You want to install a Codex, Claude, or Cursor-compatible bundle
  - You need to understand how Agdi maps bundle content into native features
...
Agdi can install plugins from three external ecosystems: **Codex**, **Claude**,
and **Cursor**. These are called **bundles** — content and metadata packs that
Agdi maps into native features like skills, hooks, and MCP tools.

<Info>
  Bundles are **not** the same as native Agdi plugins. Native plugins run
...
of requiring authors to rewrite them as native Agdi plugins, Agdi
...
Not every bundle feature runs in Agdi today. Here is what works and what
...
| ------------- | ---------------------------------------------------------------------------------------------------- | -------------- |
| Skill content | Bundle skill roots load as normal Agdi skills                                                    | All formats    |
| Commands      | `commands/` and `.cursor/commands/` treated as skill roots                                           | Claude, Cursor |
| Hook packs    | Agdi-style `HOOK.md` + `handler.ts` layouts                                                      | Codex          |
...
<AccordionGroup>
  <Accordion title="Codex bundles">
    ...
    Codex bundles fit Agdi best when they use skill roots and Agdi-style
...
<AccordionGroup>
  <Accordion title="Bundle is detected but capabilities do not run">
    Run `agdi plugins inspect <id>`. If a capability is listed but marked as
  ...
  <Accordion title="Claude settings do not apply">
    Only embedded Pi settings from `settings.json` are supported. Agdi does
  ...
  <Accordion title="Claude hooks do not execute">
    ...
    Agdi hook-pack layout or ship a native plugin.
  </Accordion>
</AccordionGroup>
