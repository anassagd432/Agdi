...
summary: "Testing utilities and patterns for Agdi plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Agdi
plugins.
...
**Import:** `agdi/plugin-sdk/testing`
...
import { installCommonResolveTargetErrorCases } from "agdi/plugin-sdk/testing";
...
1. **No monolithic root imports** -- `agdi/plugin-sdk` root barrel is rejected
...
Agdi uses Vitest with V8 coverage thresholds. For plugin tests:
