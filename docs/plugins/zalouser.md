...
read_when:
  - You want Zalo Personal (unofficial) support in Agdi
...
Zalo Personal support for Agdi via a plugin, using native `zca-js` to automate a normal Zalo user account.
...
```bash
agdi plugins install @agdi/zalouser
```
