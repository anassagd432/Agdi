...
**Goal (north star):** provide a machine-checked argument that Agdi enforces its
...
**What this is not (yet):** a proof that “Agdi is secure in all respects” or that the full TypeScript implementation is correct.
