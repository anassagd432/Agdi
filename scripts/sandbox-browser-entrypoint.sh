...
CDP_PORT="${AGDI_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${AGDI_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${AGDI_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${AGDI_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${AGDI_BROWSER_HEADLESS:-0}"
