...
show_usage() {
    cat << EOF
clawlog - Agdi Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Agdi logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Agdi logs flow through the macOS unified log (subsystem: ai.agdi).
