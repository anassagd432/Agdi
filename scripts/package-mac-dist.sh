...
# Output:
# - dist/Agdi.app
# - dist/Agdi-<version>.zip
# - dist/Agdi-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Agdi-$VERSION.zip"
DMG="$ROOT_DIR/dist/Agdi-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Agdi-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Agdi-$VERSION.dSYM.zip"
