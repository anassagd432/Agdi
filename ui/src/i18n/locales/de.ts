...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.agdi/agdi.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von agdi dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
