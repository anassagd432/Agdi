...
export const en: TranslationMap = {
  ...
  subtitles: {
    agents: "Assistants, workspaces, tools, and identities.",
    overview: "Telemetry, live task queue, and quick actions.",
    channels: "Chat apps and integration settings.",
    instances: "Connected clients and runtime nodes.",
    sessions: "Active session traces and history.",
    usage: "API usage, tokens, costs, and analytics.",
    cron: "Scheduled automations and recurring runs.",
    skills: "Workspace skills and API keys.",
    nodes: "Paired devices and commands.",
    chat: "Start work, inspect context, and hand off to agents.",
    config: "Edit agdi.json.",
    communications: "Messages, audio, and delivery settings.",
    appearance: "Theme, workspace UI, and setup wizard settings.",
    automation: "Commands, hooks, cron, and plugins.",
    infrastructure: "Runtime, web, browser, and media settings.",
    aiAgents: "Agents, models, skills, tools, memory, session.",
    debug: "Snapshots, events, RPC.",
    logs: "Live runtime console logs.",
    browser: "Visual browser automation simulator.",
    canvas: "Sandbox preview for generated HTML/JS.",
    knowledge: "Drag-and-drop RAG ingestion manager.",
  },
  overview: {
    access: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from agdi dashboard --no-open on your desktop.",
    },
    insecure: {
