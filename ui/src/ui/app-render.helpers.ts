...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as AgdiApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as AgdiApp).resetToolStream();
  (state as unknown as AgdiApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as AgdiApp;
